<%@ page import="club.swdev.webapp.model.ContactType" %>
<%@ page import="club.swdev.webapp.AppConfig" %>
<%@ page import="club.swdev.webapp.model.Resume" %>
        ...
        <div class="resumes-list">
          <table>
            ...
            <c:forEach var="resumeObj" items="${resumeList}">
              ...
              <%-- <jsp:useBean id="resumeObj" type="club.swdev.webapp.model.Resume" scope="page"/> --%>
              <%
